package net.coffeepowered.subtleforces.block;
...
import net.coffeepowered.subtleforces.block.custom.MagicBlock;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(SubtleForces.MOD_ID);
    ...
    public static final DeferredBlock<RitualFire>RITUAL_FIRE = registerBlock("ritual_fire",
            () -> new RitualFire(BlockBehaviour.Properties.of()
                    .strength(2)
